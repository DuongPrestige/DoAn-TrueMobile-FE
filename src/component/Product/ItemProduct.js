...
function ItemProduct(props) {
    return (
        <div style={{background: 'white', margin: '10px 0', borderRadius: '8px', boxShadow: '0px 1px 8px rgb(0 0 0 / 4%)'}}>
            <div style={{ cursor: 'pointer', marginBottom: '25px' }} className="single-product">
                <Link to={`/detail-product/${props.id}`}>
                    <div style={{ width: props.width, height: props.height }} className="product-img">
                        <img style={{borderRadius: '8px'}} className="img-fluid w-100 img-custom" src={props.img} alt="" />
                    ...
                    <div style={{ width: props.width, height: '99px', border: 'none' }} className="product-btm">
                        ...
                        <div className="mt-3">
                            <span className="mr-4" style={{color: '#0066CC', fontSize: 18}}>{CommonUtils.formatter.format(props.discountPrice)}</span>
