...
const Adduser = (props) => {
    ...
    /**
     * xử lý sự kiện ban đầu
     * Nếu có id => mode edit user
     * ko có => mode tạo mới
     */
    useEffect(() => {
    ...
    /**
     * set giá trị khi change dữ liệu
     * @param {*} event giá trị khi change dữ liệu
     */
    ...
    // set giá trị options của select
    ...
    // xử lý sự kiện khi click button lưu
