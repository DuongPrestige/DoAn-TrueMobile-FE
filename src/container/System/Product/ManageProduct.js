...
import { getAllProductAdmin, handleInActiveProductService, handleActiveProductService } from '../../../services/userService';
...
const ManageProduct = () => {
    ...
    let handleInActiveProduct = async (id) => {

        let data = await handleInActiveProductService({
            id: id
        })
                                            ...
                                            <tr key={index}>
                                                ...
                                                <td style={{ width: '12%' }}>
                                                    ...
                                                    {item.statusData.code === 'S1' ?
                                                        <span onClick={() => handleInActiveProduct(item.id)} style={{ color: '#0E6DFE', cursor: 'pointer' }}>Inactive</span>
