...
const AddTypeVoucher = (props) => {
  ...
  let fetchAllCodeServiceDiscount = async () => {
    let res = await getAllCodeServiceDiscount();

    if (res && res.errCode === 0) {
      setInputValues({
        ...inputValues,
        ["typeVoucher"]: res.data[0].code,
      });
    ...
    <div className="container-fluid px-4">
      ...
      <div className="card mb-4">
        <div className="card-header">
          ...
          {isActionADD === true
            ? "Thêm mới loại voucher"
            : "Cập nhật thông tin loại voucher"}
        </div>
