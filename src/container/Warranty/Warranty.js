      ...
      {dataWarranty ? (
        <>
          <div className="d-flex">
            ...
            <div className="mt-4">
              <p>{dataWarranty?.nameProdudct}</p>
              <p>{dataWarranty?.messBuyDate}</p>
              <p>{dataWarranty?.serialNumber}</p>
            </div>
          </div>
          ...
          <div style={{ border: "1px solid #ced4da" }}>
            <div className="p-4">
              ...
              <h5 className="p-2">
                Gói bảo hành của bạn bao gồm các quyền lợi sau:
              </h5>
              <div className="d-flex">
                <div className="single-feature">
                  ...
                  <p>
                    Sử dụng dịch vụ sửa chữa và bảo dưỡng được chứng nhận của
                    Apple tại một trong những Nhà cung cấp dịch vụ ủy quyền của
                    Apple
                  </p>
                </div>
                <div className="ml-4 single-feature">
                  ...
                  <p>
                    Hãy liên lạc với chúng tôi qua tính năng trò chuyện hoặc
                    điện thoại để gặp chuyên gia hỗ trợ kỹ thuật
                  </p>
                </div>
              </div>
            </div>
